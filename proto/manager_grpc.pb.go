...
type ManagerClient interface {
	GetServices(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ServiceDefinition, error)
...
func (c *managerClient) GetServices(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ServiceDefinition, error) {
...
type ManagerServer interface {
	GetServices(context.Context, *empty.Empty) (*ServiceDefinition, error)
...
func (UnimplementedManagerServer) GetServices(context.Context, *empty.Empty) (*ServiceDefinition, error) {
...
func _Manager_GetServices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManagerServer).GetServices(ctx, req.(*empty.Empty))
	}
