...
type RetranslatorControlClient interface {
	...
	ListClient(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Clients, error)
...
func (c *retranslatorControlClient) ListClient(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Clients, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Clients)
...
type RetranslatorControlServer interface {
	...
	ListClient(context.Context, *empty.Empty) (*Clients, error)
...
func (UnimplementedRetranslatorControlServer) ListClient(context.Context, *empty.Empty) (*Clients, error) {
...
func _RetranslatorControl_ListClient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RetranslatorControlServer).ListClient(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
