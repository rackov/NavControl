...
type ReceiverControlClient interface {
	...
	// список протоколов
	GetProtocols(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Protocols, error)
}
...
func (c *receiverControlClient) ListPorts(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListPortsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *receiverControlClient) GetProtocols(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Protocols, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Protocols)
...
type ReceiverControlServer interface {
	...
	// список протоколов
	GetProtocols(context.Context, *emptypb.Empty) (*Protocols, error)
...
func (UnimplementedReceiverControlServer) ListPorts(context.Context, *emptypb.Empty) (*ListPortsResponse, error) {
...
func (UnimplementedReceiverControlServer) GetProtocols(context.Context, *emptypb.Empty) (*Protocols, error) {
...
func _ReceiverControl_ListPorts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReceiverControlServer).ListPorts(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ReceiverControl_GetProtocols_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReceiverControlServer).GetProtocols(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
