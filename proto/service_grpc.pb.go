...
func (c *loggingControlClient) GetLogLevel(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*LogLevelResponse, error) {
...
func (UnimplementedLoggingControlServer) GetLogLevel(context.Context, *emptypb.Empty) (*LogLevelResponse, error) {
...
func _LoggingControl_GetLogLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoggingControlServer).GetLogLevel(ctx, req.(*emptypb.Empty))
	}
