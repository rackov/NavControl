...
func (c *serviceInfoClient) GetServiceManager(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ServiceManager, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *serviceInfoClient) GetLogLevel(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*LogLevelResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedServiceInfoServer) GetServiceManager(context.Context, *empty.Empty) (*ServiceManager, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetServiceManager not implemented")
}
func (UnimplementedServiceInfoServer) GetLogLevel(context.Context, *empty.Empty) (*LogLevelResponse, error) {
...
func _ServiceInfo_GetInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceInfoServer).GetInfo(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ServiceInfo_GetServiceManager_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceInfoServer).GetServiceManager(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ServiceInfo_GetLogLevel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceInfoServer).GetLogLevel(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
